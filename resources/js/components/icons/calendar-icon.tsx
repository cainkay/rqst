    ...
    return (
        <svg className={className} width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                stroke-linejoin="round"
            />
            <path d="M9.39062 2.49567L9.39062 9.88556" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
            <path d="M26.9902 2.49567L26.9902 9.88556" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
        </svg>
    );
};
